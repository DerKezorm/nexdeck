...
[![Integrations](https://img.shields.io/badge/integrations-126-3fb6d4)](#the-services-it-speaks-to)
...
- **A hundred and twenty-six integrations,** listed in full [further down](#the-services-it-speaks-to). Generic building blocks for everything else: a JSON API widget, a calendar that merges several sources, iframes, notes and bookmarks.
