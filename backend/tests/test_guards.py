...
def test_only_confirmed_adapters_are_out_of_beta() -> None:
    ...
    NetBird 2026-09-24 against netbird-server 0.79.0 with two clients);
    ...
    assert confirmed == {"adguard", "audiobookshelf", "authentik", "autobrr", "beszel", "changedetection", "crowdsec", "cup", "dawarich", "deluge", "docker", "duplicati", "emby", "frigate", "nexcrate",
        ...
        "backrest", "blocky", "bookorbit", "gatus", "ghostfolio", "homebox", "komodo", "netalertx", "netdata", "ollama", "openwebui", "photoprism", "pocketid", "sportarr", "tandoor", "tubearchivist", "wallos", "watchtower", "wud", "zabbix", "truenas", "nexmail", "nexpulse", "netbird"}
